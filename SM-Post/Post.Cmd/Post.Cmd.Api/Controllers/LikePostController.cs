...
public class LikePostController : ControllerBase
{
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult> LikePostAsync(Guid id)  // does not accept LikePostCommand in body, because LikePostCommand has no fields
    {
        try
        {
            await _mediator.Send(new LikePostCommand { Id = id });
