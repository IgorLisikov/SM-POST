...
public class PostAggregate : AggregateRoot
{
    ...
    // PostAggregate contains all methods for aggregate modifications, first one is constructor.
    // Every method does two things: validation and raising event (RaiseEvent() of AggregateRoot)
    ...
    public void DeletePostCommand(string username)
    {
        if (!_active)
        {
        ...
        {
            throw new InvalidOperationException("You are now allowed to delete a post that was made by someone else!");
        }
